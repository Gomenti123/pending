    ...
    <div>
      <form className="border w-[400px] p-3 sm:p-5 flex flex-col gap-3">
        ...
        <div className="flex flex-col">
          ...
          <input
            onChange={(e) => {
              setColor(e.target.value), console.log(typeof e.target.value);
            }}
            type="color"
          />
        </div>
        ...
        <div className="flex justify-center">
          <button className="border p-1 bg-green-400 rounded-md border-none w-[200px] text-white">
            Pay
          </button>
        </div>
      </form>
      <div className="flex w-full justify-center items-center h-screen">
        <div className="bg-neutral-900 w-[300px] h-[505px]">
          ...
          <div className="flex justify-center flex-col items-center mt-[100px]">
            <p className="text-[50px] text-neutral-500 font-semibold mb-[-5px]">
              ${amount}
            </p>
            <div className="text-neutral-400 flex flex-col items-center text-[12px]">
              <p>For Allowance ❤️.</p>
              <p>Authentication Fee {fee}</p>
              <p>Today at {time}</p>
            </div>
          </div>

          <div className="flex justify-center px-5 mt-[80px]">
            <button className="bg-green-500 w-full rounded-full h-[35px] text-white text-[17px] font-semibold ">
              Pending
            </button>
          </div>
        </div>
        ...
        <div className="bg-neutral-900 w-[380px] h-[350px] flex flex-col gap-3  p-5">
          ...
          <div className="flex flex-col gap-4 mt-[10px]">
            ...
            <div className="flex justify-between gap-3 text-white w-full ">
                  ...
                  <div className="flex justify-between">
                    <div>
                      ...
                      <p className="text-[14px] text-neutral-500">
                        ${amount.split(".")[0]} for Allowance ❤️.
                      </p>
                      <p className="text-[14px] text-neutral-500">{time}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <p className="text-neutral-500 font-semibold text-[17px]">
                  ${amount.split(".")[0]}
                </p>
              </div>
            </div>
